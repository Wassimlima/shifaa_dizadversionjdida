...
VALUES
    ('Admin Shifaa',            'admin@shifaa.dz',    '0555000001', '$2y$10$adminhash',    'admin',      1),
    ('Ahmed Benali',            'ahmed@shifaa.dz',    '0555000002', '$2y$10$userhash',     'patient',    1),
    ('Pharmacie El Amal Owner', 'amal@pharmacy.dz',   '0555000003', '$2y$10$pharmacyhash', 'pharmacist', 1),
    ('Karim MedRep',            'karim@medrep.dz',    '0555000004', '$2y$10$rephash',      'med_rep',    1),
    ('Lab Central Alger',       'lab@central.dz',     '0555000005', '$2y$10$labhash',      'lab',        1);
...
VALUES
    ...
    ('العناية المنزلية',  'Home Care',         '🏠', '#14b8a6', 112, 'home-care');
