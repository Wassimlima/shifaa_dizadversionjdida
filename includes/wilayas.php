<?php
// قائمة كاملة لـ 69 ولاية جزائرية مرتبة حسب الترقيم الرسمي
$wilayas = [
    ['code' => '01', 'name' => 'أدرار'],
    ['code' => '02', 'name' => 'الشلف'],
...
function getWilayaOptions($selected = '') {
    global $wilayas;
    $html = '';
    foreach ($wilayas as $w) {
        $sel = ($w['code'] === $selected) ? 'selected' : '';
        $html .= "<option value=\"{$w['code']}\" {$sel}>{$w['code']} - {$w['name']}</option>";
    }
    return $html;
}
?>